  ...
  return (
    <section className="relative bg-[#0B1629] px-14 pt-28 pb-20 overflow-hidden min-h-screen">
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <motion.div {...fadeUp(0.4)} className="flex gap-14 flex-wrap border-t border-white/10 pt-10">
          {[
        ...
        <motion.div {...fadeUp(0.5)} className="flex flex-wrap gap-3 mt-10">
          {[
            { count: 1,  label: "Monetario",    bg: "bg-blue-900/40",   border: "border-blue-700/50",   text: "text-blue-200" },
            { count: 7,  label: "Renta Fija",   bg: "bg-green-900/40",  border: "border-green-700/50",  text: "text-green-200" },
            { count: 3,  label: "Mixtos/Alt.",  bg: "bg-yellow-900/40", border: "border-yellow-700/50", text: "text-yellow-200" },
            { count: 4,  label: "Renta Variable", bg: "bg-red-900/40", border: "border-red-700/50",    text: "text-red-200" },
          ].map((c) => (
            <span
              key={c.label}
